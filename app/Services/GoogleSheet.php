...
class GoogleSheet
{
    ...
    {
        $this->spreadSheetId = config('lazada.google_sheet_id');
    ...
    public function readGoogleSheet()
    {
        ...
        $colRange = 'Sheet2!1:1';
        $range = 'Sheet2!A1:' . $dimensions['colCount'];
    ...
    private function getDimensions($spreadSheetId)
    {
        $rowDimensions = $this->googleSheetService->spreadsheets_values->batchGet(
            $spreadSheetId,
            ['ranges' => 'Sheet2!A:A','majorDimension'=>'COLUMNS']
        );
        ...
        $colDimensions = $this->googleSheetService->spreadsheets_values->batchGet(
            $spreadSheetId,
            ['ranges' => 'Sheet2!1:1','majorDimension'=>'ROWS']
        );
